...
## [0.9.0](https://github.com/toininoi/WrenAI/compare/wren-v0.8.1...wren-v0.9.0) (2026-06-02)


### ⚠ BREAKING CHANGES

* **wren:** rename PyPI package from wren-engine to wrenai ([#2315](https://github.com/toininoi/WrenAI/issues/2315))
...
* **context:** bind a connection profile to a project ([#2251](https://github.com/toininoi/WrenAI/issues/2251)) ([41fbe41](https://github.com/toininoi/WrenAI/commit/41fbe411fd1f1bb7a4080fbcedc7c886678276d1))
...
* **wren:** .env-driven profile secrets, auto connection validation, and wren-install-guide skill ([#1588](https://github.com/toininoi/WrenAI/issues/1588)) ([bdd0758](https://github.com/toininoi/WrenAI/commit/bdd0758e0778d97a187178e60e663944a221ceaa))
* **wren:** add `wren docs connection-info` CLI command ([#1507](https://github.com/toininoi/WrenAI/issues/1507)) ([6159d98](https://github.com/toininoi/WrenAI/commit/6159d98efb0449f5b167815a5018ef28e0e6914e))
* **wren:** add dbt import workflow ([#2279](https://github.com/toininoi/WrenAI/issues/2279)) ([0bd16b8](https://github.com/toininoi/WrenAI/commit/0bd16b8a95c7f599488177f9a56e232c17760e25))
* **wren:** add LanceDB-backed memory layer for schema and query retrieval ([#1494](https://github.com/toininoi/WrenAI/issues/1494)) ([d8c1511](https://github.com/toininoi/WrenAI/commit/d8c1511049725b19541ac57b6106368615b1739e))
* **wren:** add memory list, forget, dump & load commands ([#1531](https://github.com/toininoi/WrenAI/issues/1531)) ([8660f58](https://github.com/toininoi/WrenAI/commit/8660f587cfd13dc7647bdb750482e5c3f5468962))
* **wren:** add profile management for named connection profiles ([#1509](https://github.com/toininoi/WrenAI/issues/1509)) ([85ea8bb](https://github.com/toininoi/WrenAI/commit/85ea8bb5a441957b49bec0bcb340c3aa977460a9))
* **wren:** add standalone wren Python SDK package ([#1471](https://github.com/toininoi/WrenAI/issues/1471)) ([5bc9893](https://github.com/toininoi/WrenAI/commit/5bc98938b4ebb867f19e4b2e28dce89e272efdd6))
* **wren:** build MDL manifests from OSI semantic models ([#2322](https://github.com/toininoi/WrenAI/issues/2322)) ([983cf8b](https://github.com/toininoi/WrenAI/commit/983cf8bff589b5028b611bcb1ef89834990f9517))
* **wren:** CLI 0.2.0 — context management, profiles, strict mode & memory ([#1522](https://github.com/toininoi/WrenAI/issues/1522)) ([b31a1c1](https://github.com/toininoi/WrenAI/commit/b31a1c191fe7a9893538376a75fe142558c08dcd))
* **wren:** CTE-based SQL planning with per-model expansion ([#1479](https://github.com/toininoi/WrenAI/issues/1479)) ([d70f789](https://github.com/toininoi/WrenAI/commit/d70f789bb99a7786d7281552b163fa324e318463))
* **wren:** extend standalone CLI with MySQL support and auto-discovery ([#1476](https://github.com/toininoi/WrenAI/issues/1476)) ([c7e7133](https://github.com/toininoi/WrenAI/commit/c7e7133d659986d914b6346d1d4fc2c1b4f0822a))
* **wren:** generate AGENTS.md during `wren context init` ([#1526](https://github.com/toininoi/WrenAI/issues/1526)) ([9990bc8](https://github.com/toininoi/WrenAI/commit/9990bc866859305a3fe183835942e4a0ea0252cd))
* **wren:** preserve SELECT * in CTE rewriter ([#1536](https://github.com/toininoi/WrenAI/issues/1536)) ([0afaef7](https://github.com/toininoi/WrenAI/commit/0afaef737292189d36a59fab61728d9ca6d2ad35))


### Bug Fixes

* **oracle:** replace ibis[oracle] with native oracledb cursor connector ([#1495](https://github.com/toininoi/WrenAI/issues/1495)) ([a230488](https://github.com/toininoi/WrenAI/commit/a2304880e41bcb826ceb69bf8173caca3f39226e))
* **wren:** address CodeRabbit review feedback ([a28058d](https://github.com/toininoi/WrenAI/commit/a28058d4bb2ba958dd329c0348192bfebaf1d835))
* **wren:** fix CLI 0.2.0 docs — description placement, install extras, CLI flags ([#1523](https://github.com/toininoi/WrenAI/issues/1523)) ([72c4917](https://github.com/toininoi/WrenAI/commit/72c491750254dc9d30c64c419b38b2caa28bbb7f))
* **wren:** honor SQL identifier case across policy, extract, and CTE rewriter ([#2310](https://github.com/toininoi/WrenAI/issues/2310)) ([9b5fe22](https://github.com/toininoi/WrenAI/commit/9b5fe22ee35209ec23ec3bd4fe2b04133407a8bc))
* **wren:** suppress model-loading noise and improve memory CLI error message ([#1529](https://github.com/toininoi/WrenAI/issues/1529)) ([1135c0c](https://github.com/toininoi/WrenAI/commit/1135c0c333f6b1a08c84afa29c8d8d7ccead5cbb))


### Dependencies

* clear 5 high-severity Dependabot alerts on main ([#2330](https://github.com/toininoi/WrenAI/issues/2330)) ([cee71e6](https://github.com/toininoi/WrenAI/commit/cee71e6444025599d0949b8761e9fdf23abf2c04))
* **wren:** bump transitive deps for security patches ([d064db6](https://github.com/toininoi/WrenAI/commit/d064db69ef7319c558c3fc29beedde16c17a921f))


### Documentation

* **wren:** rebrand README to Wren AI and expand rename migration note ([#2316](https://github.com/toininoi/WrenAI/issues/2316)) ([f3a00eb](https://github.com/toininoi/WrenAI/commit/f3a00eb971a27186824954eff64b32f7e290db3c))


### Miscellaneous Chores

* **wren:** rename PyPI package from wren-engine to wrenai ([#2315](https://github.com/toininoi/WrenAI/issues/2315)) ([20cffa9](https://github.com/toininoi/WrenAI/commit/20cffa904f2d47c048c9247a77687b3fdfe24416))
